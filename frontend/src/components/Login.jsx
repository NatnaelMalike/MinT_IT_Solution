	...
	<form action="" className="space-y-12">
		<div className="space-y-4">
			<div>
				...
				<input type="email" name="email" id="email" placeholder="user@gmail.com" className="w-full px-3 py-2 border rounded-md dark:border-gray-300 dark:bg-gray-50 dark:text-gray-800" />
			</div>
			<div>
